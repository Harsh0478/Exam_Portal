  ...
  handleTabSwitch = () => {
    if (document.hidden) {
      this.setState(prevState => {
        const newCount = prevState.tabSwitchCount + 1;
        if (newCount === 1) {
          alert("⚠ Warning: Do not switch tabs during the test.");
        } else if (newCount >= 2) {
          alert("❌ You switched tabs again. Test is being submitted.");
          this.endtest(); // force submit test
        }
        ...
        <div className={this.props.classes.flexdiv}>
          ...
          <div className={this.props.classes.questiondiv}>
            ...
            <TestQuestion
              ...
              answer={this.props.taketest.answersheet.answers[this.state.curIndex]}
            />
            <br />
